<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/" mode="head">
		...
		<link rel="icon" type="image/png" href="{$root}img/favicon-16x16.png" />
		<link rel="icon" type="image/png" href="{$root}img/favicon-32x32.png" />
		<link rel="icon" type="image/png" href="{$root}img/favicon-96x96.png" />
        <link rel="apple-touch-icon" sizes="57x57" href="{$root}img/apple-icon-57x57.png" />
        <link rel="apple-touch-icon" sizes="60x60" href="{$root}img/apple-icon-60x60.png" />
        <link rel="apple-touch-icon" sizes="72x72" href="{$root}img/apple-icon-72x72.png" />
        <link rel="apple-touch-icon" sizes="76x76" href="{$root}img/apple-icon-76x76.png" />
        <link rel="apple-touch-icon" sizes="114x114" href="{$root}img/apple-icon-114x114.png" />
        <link rel="apple-touch-icon" sizes="120x120" href="{$root}img/apple-icon-120x120.png" />
        <link rel="apple-touch-icon" sizes="144x144" href="{$root}img/apple-icon-144x144.png" />
        <link rel="apple-touch-icon" sizes="152x152" href="{$root}img/apple-icon-152x152.png" />
        <link rel="apple-touch-icon" sizes="180x180" href="{$root}img/apple-icon-180x180.png" />
    </xsl:template>
